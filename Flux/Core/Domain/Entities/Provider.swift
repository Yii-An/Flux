...
struct ProviderDescriptor: Codable, Sendable, Identifiable, Hashable {
    ...
    static let defaults: [ProviderDescriptor] = [
        ...
        .init(id: .claude, displayNameKey: "provider_claude", authKind: .file, supportsQuota: false),
        ...
        .init(id: .copilot, displayNameKey: "provider_copilot", authKind: .cli, supportsQuota: false),
